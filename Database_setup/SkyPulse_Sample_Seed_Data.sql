-- ============================================================
-- SKY PULSE MONITORING SYSTEM • CLEAN SEED DATA (v5)
-- Fully compatible with current schema
-- Primary admin: raddamestonui48@gmail.com
-- ============================================================
...
INSERT INTO users (first_name, last_name, user_email, password_hash, role_id, company_id)
SELECT 'Carol','Wanjiku','raddamestonui48@gmail.com',
...
INSERT INTO users (first_name, last_name, user_email, password_hash, role_id, company_id)
SELECT 'John','Dowe','raddamestonui@gmail.com',
