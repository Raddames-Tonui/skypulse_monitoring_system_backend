...
ERD - docker exec -it skypulse-database pg_dump -U spadmin -d skypulse_monitoring_system_database -s -F p -E UTF-8 > D:\pg_schema.sql
  ...
  -e POSTGRES_PASSWORD='skyp@lse!2020' \
  -e POSTGRES_DB=skypulse_monitoring_system_database \
  -v ~/docker/skypulse_db/data:/var/lib/postgresql/data \
  -p 5434:5432 \
  -d postgres:latest
