...
public class RefreshTokenHandler implements HttpHandler {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        try (Connection conn = Objects.requireNonNull(DatabaseManager.getDataSource()).getConnection()) {
            ...
            String selectUser = "SELECT user_email, uuid, role_id FROM users WHERE user_id = ?";
            String email;
            UUID userUuid;
            Integer roleId;
            ...
            String updateAuth = "UPDATE auth_sessions SET refresh_token_hash = ?, expires_at = ?, last_used_at = ? WHERE jwt_id = ?";
